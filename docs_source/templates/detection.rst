...
.. dropdown:: detection_plain.yaml
	:open:

	.. literalinclude :: ../../../../phenopype-templates/templates/detection/detection_plain.yaml
		:language: python
		:linenos:
...
.. dropdown:: detection_mask.yaml

	.. literalinclude :: ../../../../phenopype-templates/templates/detection/detection_mask.yaml
		:language: python
		:linenos:
...
.. dropdown:: detection_ref.yaml

	.. literalinclude :: ../../../../phenopype-templates/templates/detection/detection_ref.yaml
		:language: python
		:linenos:
...
.. dropdown:: detection_mask_ref.yaml

	.. literalinclude :: ../../../../phenopype-templates/templates/detection/detection_mask_ref.yaml
		:language: python
		:linenos:
